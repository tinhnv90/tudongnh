...
<div id="content" class="w100min">
	<div id="conten-right" class="bor-box">
		<div id="product-detail" class="w100min">
			...
			<div class="left bor-box">
				...
				<?php if(isset($listimages)){$countlistimg=count($listimages);$countlistimg++;} ?>
				<div id="list-images" class="w100min @if(isset($listimages) && $countlistimg>4)scroll-x @endif">
					<ul class="wh100" 
						@if(isset($listimages) && 4<$countlistimg) style='width:<?php echo $countlistimg*82; ?>px' @endif>
